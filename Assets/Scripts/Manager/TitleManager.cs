...
public class TitleManager : Singletone<TitleManager>
{
    ...
    private void Start()
    {
        ...
        login.btnTry.onClick.AddListener(() =>
        {
            ...
            K.clientInfo = new UserInfo { hostID = User.netClient.GetLocalHostID(), ID = login.tmpInputID.text, PW = login.tmpInputPW.text, roomID = -1 };
        });
        ...
        sign.btnTry.onClick.AddListener(() =>
        {
            ...
            K.clientInfo = new UserInfo { hostID = User.netClient.GetLocalHostID(), ID = sign.tmpInputID.text, PW = sign.tmpInputPW.text, roomID = -1 };
        });
    }
